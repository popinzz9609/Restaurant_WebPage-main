...
REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CALSSES': [
        ...
        'rest_framework.renderer.BrowsableAPIRender',
    ],
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.renderer.authentication.TokenAuthentication',
        'rest_framework.renderer.authentication.SessionAuthentication',
    ]
}
